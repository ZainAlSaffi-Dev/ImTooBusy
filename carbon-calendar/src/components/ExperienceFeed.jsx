...
// EducationCard: UPDATED (Removed Bottom Connector Line)
    ...
    <div className="relative mb-24">
       ...
       <div className="w-full p-8 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm hover:border-carbon-primary/30 transition-all group">
          <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
              ...
              {/* Icon Box */}
              <div className="p-4 rounded-xl bg-carbon-primary/10 text-carbon-primary shrink-0 border border-carbon-primary/20">
                  {data.icon}
              </div>
       ...
       {/* (DELETED) The Connector Line div was here */}
    </div>
);

// Standard Timeline Item (Left/Right Split)
      ...
      <div className="flex-1 pl-8 md:pl-0">
        <div className="p-6 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 transition-colors backdrop-blur-sm group">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-carbon-muted">{data.icon}</span>
          </div>
